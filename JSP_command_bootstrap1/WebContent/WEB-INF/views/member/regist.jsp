...
<form role="imageForm" action="upload/picture" method="post" enctype="multipart/form-data">
	...
	<input type="hidden" name="checkUpload" value="0" /> <!-- 0이면 업로드가 안 됨  181번 line-->
</form>
...
function upload_go(){
	...
	//var formData = new FormData(document.querySelector('form[role="imageForm"]'));
		$.ajax({
			url:"picture.do",
			data:formData,
			type:"post",
			...
			success:function(data){
				...
				//저장된 파일명 저장
				$('input#oldFile').val(data);//변경 시 삭제될 파일 명
